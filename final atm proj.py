...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#1f1f2e')
        self.controller = controller

        self.controller.title('securitex')
        self.controller.state('zoomed')
        self.controller.iconphoto(False,
                                  tk.PhotoImage(file='C:/Users/sree/Downloads/atm.png'))
        ...
        space_label=tk.Label(self,height=4,bg='#1f1f2e')
        space_label.pack()
        ...
        visa_photo=tk.PhotoImage(file='C:/Users/sree/Downloads/visa.png')
        visa_label=tk.Label(bottom_frame,image=visa_photo)
        visa_label.pack(side='left')
        visa_label.image=visa_photo

        mastercard_photo=tk.PhotoImage(file='C:/Users/sree/Downloads/mastercard.png')
        ...
        american_express_photo=tk.PhotoImage(file='C:/Users/sree/Downloads/american-express.png')
...
class DepositPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        two_tone_label=tk.Label(self,bg='#1f1f2e')
